...
final class SavedCards
{
    ...
    public function createTokenIntention(IntentionData|array $data): PaymobResponse
    {
    ...
    public function merchantInitiatedIntention(IntentionData|array $data): PaymobResponse
    {
        return $this->intentions->create($data);
    }
